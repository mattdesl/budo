...
function createHandler(opts) {
  ...
  var staticFolder = opts.static ? ecstatic({root: opts.static, handleError: false}) : undefined;
  var staticHandler = ecstatic({root: basedir});
  var router = Router()
